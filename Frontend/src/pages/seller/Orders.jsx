...
const Orders = () => {
  ...
  return (
    <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll mt-16 pb-16">
      <div className="md:p-10 p-4 space-y-4">
          <h2 className="text-lg font-medium">Orders List</h2>
          {orders.map((order, index) => (
              <div key={index} className="flex flex-col md:itemscenter md:flex-row gap-5 p-5  justify-between max-w-4xl rounded-md border border-gray-300">
